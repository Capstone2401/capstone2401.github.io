...
export function SDKPreview(): JSX.Element {
  return (
    <div className="bg-zinc-100 border-y border-zinc-300 flex flex-col md:flex-row justify-center items-center gap-20 py-20 px-10 dark:border-zinc-950 dark:bg-zinc-900">
      <div>
