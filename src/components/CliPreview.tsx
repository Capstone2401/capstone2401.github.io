export default function CliPreview(): JSX.Element {
  return (
    <div className="-z-20 flex md:flex-row flex-col border-y border-zinc-300 dark:border-zinc-950 justify-center items-center gap-16 py-20 px-10 bg-zinc-100 dark:bg-zinc-900">
